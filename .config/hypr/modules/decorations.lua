...
hl.animation({ leaf = "border",        enabled = true,  speed = 4.39, bezier = "quick" })
...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 1.91, bezier = "md3_decel", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 1.94, bezier = "md3_decel", style = "slide" })
